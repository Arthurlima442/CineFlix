//
//  MovieDetailWatchProvidersCell.swift
//  CineFlix
//
...
class MovieDetailWatchProvidersCell: UITableViewCell {
    
    static let identifier = "MovieDetailWatchProvidersCell"
    ...
    // MARK: - Configure
    func configure(with watchProviders: WatchProvidersResponse?) {
        ...
        var selectedRegion: WatchProviderRegion?
    ...
    private func extractUniquProviders(from region: WatchProviderRegion) -> [WatchProvider] {
